...
export default function LoginPage() {
  ...
  async function handleLogin() {
    ...
    // Bruk window.location for garantert full navigasjon
    if (profile?.is_admin) {
    ...
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: '380px' }}>
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          <Link href="/" style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              fontSize: '28px', fontWeight: 700, color: '#c93960', marginBottom: '6px',
            }}>
              Partiet Sentrum
            </div>
          </Link>
        ...
        <div style={{
          ...
          boxShadow: '0 4px 24px rgba(0,0,0,.07)', padding: '32px',
        }}>
          {mode === 'login' ? (
            <>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <div>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                    ...
                    <button onClick={() => setMode('reset')} type="button" style={{
                      fontSize: '12px', color: '#c93960', fontWeight: 600,
              ...
              <button onClick={handleLogin} disabled={loading} type="button" style={{
                ...
                borderRadius: '10px', border: 'none', background: '#c93960',
            ...
            <div style={{ textAlign: 'center', padding: '16px 0' }}>
              ...
              <h3 style={{
                ...
                fontWeight: 700, color: '#0f0f1a', marginBottom: '8px',
              }}>Sjekk e-posten</h3>
              <p style={{ fontSize: '13px', color: '#6b7280', marginBottom: '20px' }}>
                Lenke sendt til <strong>{email}</strong>
              </p>
              <button
                onClick={() => { setMode('login'); setResetSent(false) }}
                type="button"
                style={{
                  fontSize: '13px', color: '#c93960', fontWeight: 700,
