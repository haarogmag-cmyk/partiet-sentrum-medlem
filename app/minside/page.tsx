...
    // FIKS: Fjerner h-full for å la kortet krympe/vokse etter innhold, og unngå overflow.
    return (
        <Link href={`/minside/event/${ev.id}`} className="block">
            <div className="bg-slate-50 hover:bg-white border border-slate-100 hover:border-ps-primary/30 p-4 rounded-xl transition-all shadow-sm hover:shadow-md group flex flex-col justify-between">
                <div>
